"""
Coolbet Scraper (Kambi CDN)
Coolbet is a Nordic sportsbook powered by Kambi.
Uses the same Kambi CDN as Unibet but with 'coolbet' operator key.
...
KAMBI_BASE = "https://eu-offering-api.kambicdn.com/offering/v2018/coolbet"
...
# Sport path mappings for Coolbet Kambi
SPORT_MAP = {
...
async def fetch_sport(sport_key: str) -> List[SportsbookSnapshot]:
    """
    Fetch odds from Coolbet for a given sport.
    ...
    async with httpx.AsyncClient(timeout=20.0, follow_redirects=True) as client:
        try:
            ...
            print(f"[Coolbet] Error fetching {sport_key}: {e}")
            return []
