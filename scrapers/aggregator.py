...
SPORT_SLUGS = {
    "nba": {
        ...
        "maxbet_ba": "basketball_nba",
        "soccerbet_ba": "basketball_nba",
        "betole_ba": "basketball_nba",
        "maxbet_mk": "basketball_nba",
        "soccerbet_ba": "basketball_nba",
        "betole_ba": "basketball_nba",
    ...
    "nfl": {
        ...
        "maxbet": "football_nfl",
        "maxbet_ba": "football_nfl",
        "soccerbet_ba": "football_nfl",
        "betole_ba": "football_nfl",
        "maxbet_mk": "football_nfl",
        "soccerbet_ba": "football_nfl",
        "betole_ba": "football_nfl",
    ...
    "mlb": {
        ...
        "maxbet": "baseball_mlb",
        "maxbet_ba": "baseball_mlb",
        "soccerbet_ba": "baseball_mlb",
        "betole_ba": "baseball_mlb",
        "maxbet_mk": "baseball_mlb",
        "soccerbet_ba": "baseball_mlb",
        "betole_ba": "baseball_mlb",
    ...
    "nhl": {
        ...
        "maxbet_ba": "ice_hockey_nhl",
        "soccerbet_ba": "ice_hockey_nhl",
        "betole_ba": "ice_hockey_nhl",
        "maxbet_mk": "ice_hockey_nhl",
        "soccerbet_ba": "ice_hockey_nhl",
        "betole_ba": "ice_hockey_nhl",
    ...
    "ncaaf": {
        ...
        "maxbet_ba": "football_ncaaf",
        "soccerbet_ba": "football_ncaaf",
        "betole_ba": "football_ncaaf",
        "maxbet_mk": "football_ncaaf",
        "soccerbet_ba": "football_ncaaf",
        "betole_ba": "football_ncaaf",
    ...
    "ncaab": {
        ...
        "maxbet_ba": "basketball_ncaab",
        "soccerbet_ba": "basketball_ncaab",
        "betole_ba": "basketball_ncaab",
        "maxbet_mk": "basketball_ncaab",
        "soccerbet_ba": "basketball_ncaab",
        "betole_ba": "basketball_ncaab",
    ...
    "rugby": {
        ...
        "maxbet": "rugby_union",
        "maxbet_ba": "rugby_union",
        "soccerbet_ba": "rugby_union",
        "betole_ba": "rugby_union",
        "maxbet_mk": "rugby_union",
        "soccerbet_ba": "rugby_union",
        "betole_ba": "rugby_union",
    ...
    "table_tennis": {
        ...
        "maxbet": "table_tennis",
        "maxbet_ba": "table_tennis",
        "soccerbet_ba": "table_tennis",
        "betole_ba": "table_tennis",
        "maxbet_mk": "table_tennis",
        "soccerbet_ba": "table_tennis",
        "betole_ba": "table_tennis",
    ...
    "volleyball": {
        ...
        "maxbet": "volleyball",
        "maxbet_ba": "volleyball",
        "soccerbet_ba": "volleyball",
        "betole_ba": "volleyball",
        "maxbet_mk": "volleyball",
        "soccerbet_ba": "volleyball",
        "betole_ba": "volleyball",
    ...
    "rugby_league": {
        ...
        "maxbet": "rugby_league",
        "maxbet_ba": "rugby_league",
        "soccerbet_ba": "rugby_league",
        "betole_ba": "rugby_league",
        "maxbet_mk": "rugby_league",
        "soccerbet_ba": "rugby_league",
        "betole_ba": "rugby_league",
    ...
    "aussie_rules": {
        ...
        "maxbet": "aussie_rules",
        "maxbet_ba": "aussie_rules",
        "soccerbet_ba": "aussie_rules",
        "betole_ba": "aussie_rules",
        "maxbet_mk": "aussie_rules",
        "soccerbet_ba": "aussie_rules",
        "betole_ba": "aussie_rules",
    ...
    "motor_sports": {
        ...
        "maxbet": "motor_sports",
        "maxbet_ba": "motor_sports",
        "soccerbet_ba": "motor_sports",
        "betole_ba": "motor_sports",
        "maxbet_mk": "motor_sports",
        "soccerbet_ba": "motor_sports",
        "betole_ba": "motor_sports",
...
SPORTSBOOK_INFO = [
    ...
    # ─── v10.1 Additions ───
    {"name": "MaxBet BA", "type": "Balkans", "region": "Bosnia", "description": "MaxBet Bosnia — 330 soccer events, 2.56MB data with ML/spread/total"},
    {"name": "MaxBet MK", "type": "Balkans", "region": "North Macedonia", "description": "MaxBet North Macedonia — 330 soccer events, 2.55MB data with ML/spread/total"},
    # ─── v10.2 Additions ───
...
async def fetch_single_book(sport_key: str, sportsbook: str) -> List[SportsbookSnapshot]:
    ...
    try:
        ...
        elif sb in ("maxbetba", "maxbet_ba", "maxbet ba"):
            sport = slug_info.get("maxbet_ba")
            if sport:
                snapshots = await balkan_factory.fetch_operator_sport("maxbet_ba", sport)
        elif sb in ("maxbetmk", "maxbet_mk", "maxbet mk"):
            sport = slug_info.get("maxbet_mk")
            if sport:
                snapshots = await balkan_factory.fetch_operator_sport("maxbet_mk", sport)
        elif sb in ("soccerbetba", "soccerbet_ba", "soccerbet ba"):
            sport = slug_info.get("soccerbet_ba")
            if sport:
                snapshots = await balkan_factory.fetch_operator_sport("soccerbet_ba", sport)
        elif sb in ("betoleba", "betole_ba", "betole ba"):
            sport = slug_info.get("betole_ba")
            if sport:
                snapshots = await balkan_factory.fetch_operator_sport("betole_ba", sport)
